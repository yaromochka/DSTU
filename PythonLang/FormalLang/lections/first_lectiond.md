...
V:
    <div align="center">
    <br>1. ε - цепочка в алфавите V;
    <br>2. если α - цепочка в алфавите V и а – символ этого алфавита, то αа – 
    цепочка в алфавите V;
    <br>3. β - цепочка в алфавите V тогда и только тогда, когда она является таковой 
...
виде α→β (читается: «из цепочки α выводится цепочкаβ»);
...
<div align="center"><img src="/Users/yaromochka/IdeaProjects/DSTU/PythonLang/FormalLang/lections/photos/grammatic_types.png" alt=""></div>
...
а) Язык типа 0 L(G)={ 2 1 | 1 2a bn − n ≥ } определяется грамматикой с прави-
лами вывода:
1) S → aaCFD; 
2) AD → D;
3) F → AFB | AB; 
...
б) Контекстно-зависимый язык L(G)={anbncn | n≥1} определяется грамматикой 
с правилами вывода:
1) S → aSBC | abc ; 
2) bC → bc;
3) CB → BC;
